...
public class SCaptcha {
    ...
    private char[] codeSequence = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'M', 'N', 'P', 'Q', 'R',
            'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'k', 'i', 'j', 'k', 'm', 'n', 'p', 'r',
            's', 't', 'u', 'v', 'w', 'x', 'y', 'z', '2', '3', '4', '5', '6', '7', '8', '9' };
    // 生成随机数
    private Random random = new Random();

    private final String SESSION_NAME = "verification";

    public void setRandInSession(HttpServletRequest req) {
        req.getSession().setAttribute(SESSION_NAME, getCode());
    }

    public String getRandFromSession(HttpServletRequest req) {
