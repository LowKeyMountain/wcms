...
<!-- 						                
														...
														<table id="cargoProgressStats" class="table table-striped table-bordered table-hover table-checkable order-column"></table>
													</form>
										</div>
						</div>
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/core/report/cargoInfoStats.js?v=${jsVersion}"
			type="text/javascript"></script>
	<script>
