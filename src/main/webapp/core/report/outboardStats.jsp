				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="${IncPath}/report/shiplist?reportType=7">舱外作业量统计</a><i class="fa fa-angle-right"></i>
							</li>							
							<li>统计结果</li>
						</ul>
...
<!-- 						                
														...
														<table id="outBoardStats" class="table table-striped table-bordered table-hover table-checkable order-column"></table>
													</form>
										</div>
						</div>
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/core/report/outboardStats.js?v=${jsVersion}"
			type="text/javascript"></script>
	<script>
