				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="${IncPath}/report/shiplist?reportType=4">船舶班次作业量统计</a><i class="fa fa-angle-right"></i>
							</li>														
							<li>船舶班次作业量统计</li>
						</ul>
						                ...
						                <div class="col-md-12">
									        <div class="panel panel-primary">
									            <div class="panel-heading">
									            		<h3 class="panel-title">船舶班次作业量统计</h3></div>
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/core/report/statistics.js?v=${jsVersion}"
			type="text/javascript"></script>
