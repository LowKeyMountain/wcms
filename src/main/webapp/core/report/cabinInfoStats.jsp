					...
					<div class="col-md-12">
						...
						<div class="portlet box yellow">
								<div class="portlet-title">
									<div class="caption">
										<i><a href="javascript:view_click(${cargoId})">${cargoName}</a></i>
									</div>
									<div class="tools">
...
<!-- 						                
														...
														<table id="cabinInfoStats" class="table table-striped table-bordered table-hover table-checkable order-column"></table>
													</form>
										</div>
						</div>
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/core/report/cabinInfoStats.js?v=${jsVersion}"
			type="text/javascript"></script>
	<script>
