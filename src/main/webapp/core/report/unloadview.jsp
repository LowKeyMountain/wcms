									            ...
									            <div class="panel-body">
									                <form id="formSearch" class="form-horizontal">
									                    ...
									                    <div class="form-group" style="margin-top:5px;margin-bottom:5px">
									                        ...
									                        <label class="control-label col-md-1" for="cabinNo">舱号: </label>
									                        <div class="col-md-2">
																<select id="cabinNo" name="cabinNo" class="form-control select2me">
																	<option value="">请选择...</option>
																</select>
									                        </div>
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/core/report/unloadview.js?v=${jsVersion}"
			type="text/javascript"></script>
	<script>
