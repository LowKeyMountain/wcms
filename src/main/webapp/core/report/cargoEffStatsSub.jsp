					...
					<div class="col-md-12">
						...
						<div class="portlet box yellow">
								<div class="portlet-title">
									<div class="caption">
										<i><a href="javascript:view_cargo(${cargoId})">${cargoName}</a></i>
									</div>
									<div class="tools">
...
<!-- 						                
														...
														<table id="cabinEffStatsSub" class="table table-striped table-bordered table-hover table-checkable order-column"></table>
													</form>
										</div>
						</div>
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/core/report/cargoEffStatsSub.js?v=${jsVersion}"
			type="text/javascript"></script>
	<script>
