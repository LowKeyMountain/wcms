	function initTable(){
		$('#workShiftStats').bootstrapTable("destroy").bootstrapTable({  // init via javascript
			method : 'post',
...
//						 sort: params.sort,
		    ...
		    columns: [{
		        ...
		        formatter: function (value, row, index) {
                    var html = "<a href='javascript:view_unloader(\"" + taskId + "\",\"" + row.unloaderId  + "\",\"" + $("#searchDate").val()  + "\",\"" + $("#shift").val() + "\")' class='font-weight-normal'>" + row.unloaderName + "</a>";
                    return html;
                },
		        footerFormatter: '合计'
		    }, {
