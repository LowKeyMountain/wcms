	function initTable(){
		...
		$('#unloader').bootstrapTable("destroy").bootstrapTable({  // init via javascript
			...
			url:BasePath + "/unloader/getUnloaderHistoryParamList?rnd=" + Math.random(),
			dataType : 'json',
...
$(function(){
        ...
        $('#btn_submit').off().on("click", function () {
        	...
        	var data={
        			...
        			doumenOpeningDegree:$("#doumenOpeningDegree").val(),			             
        			hopperLoad: $("#hopperLoad").val()
        	}
            $.ajax({
                url: BasePath + "/unloader/addUnloaderParam",
                type: "post",
                dataType: "json",
                cache: false,
                async:false,
