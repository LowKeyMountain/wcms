			        ...
			        <div class="modal-content">
			            <div class="modal-header bg-primary">
			                ...
			                <h4 class="modal-title">
			                    ...
			                    <span id="lblAddTitle" style="font-weight:bold">卸船机参数模拟生成器</span>
			                </h4>
			            </div>
			                    ...
			                    <div class="modal-body" >
									...
									<div class="alert alert-success display-hide">
			                            ...
			                            <div class = "input-group" >
			                             ...
			                             -->
			                            <div class = "input-group" >
			                                <span class="input-group-addon text-center"><b class="icon-td">更新时间</b></span>
										...
										<div class = "input-group" id="move_div">
			                                <span class="input-group-addon text-center"><b class="icon-td">给料速度（%）</b></span>
			                                <input type = "text"  class=" form-control"  name="deliveryRate" id="deliveryRate"  placeholder="请输入给料速度" value="0" style="width:240px;">
			                            </div>								                            
										<div class = "input-group" id="onetask_div">
			                                <span class="input-group-addon text-center"><b class="icon-td">斗门开度（%）</b></span>
			                                <input type = "text"  class=" form-control"  name="doumenOpeningDegree" id="doumenOpeningDegree"  placeholder="请输入斗门开度（%）" value="0" style="width:240px;">
			                            </div>
										<div class = "input-group" id="onetask_div">
			                                <span class="input-group-addon text-center"><b class="icon-td">料斗荷载（吨）</b></span>
			                                <input type = "text"  class=" form-control"  name="hopperLoad" id="hopperLoad"  placeholder="请输入料斗荷载（吨）" value="0" style="width:240px;">
			                            </div>
			                    </div>                            
			                    </form>
			                </div>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<!-- <h3 class="page-title icon-settings">&nbsp;&nbsp;卸船机参数管理</h3> -->
							...
							<div class="portlet-title">
								<div class="caption font-dark">
									<i class="icon-settings font-dark"></i> <span
										class="caption-subject bold uppercase"> 卸船机参数列表</span>
								</div>
								<div class="tools"> </div>
							</div>
									                ...
									                <form id="formSearch" class="form-horizontal">
									                    <div class="form-group" style="margin-top:5px;margin-bottom:5px">
									                        ...
									                        <div class="col-md-3">
							     							...
							     							<label class="control-label  col-md-1 cy-pad-hor-s">更新时间：</label>
									                    ...
									                    <div class="form-group" style="margin-top:5px;margin-left:700px;margin-bottom:5px">
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/core/unloader/history_param_list.js?v=${jsVersion}"
			type="text/javascript"></script>
