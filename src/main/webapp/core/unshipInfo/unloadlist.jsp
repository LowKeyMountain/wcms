						...
						<div class="tab-pane" id="cabin">
							<div class="portlet box yellow">
								<div class="portlet-title">
									<div class="caption">
										<i><a href="javascript:view_ship_click(${taskId})">${shipName}</a></i>
									</div>
									<div class="tools">
...
<!-- 										<div class="dropdown" id="toolbar" >
										  ...
										  <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
										    <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:unloadProgress_click(${taskId})">货物进度</a></li>
										    <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:unloaderOverview_click(${taskId})">卸船机总览</a></li>
										  </ul>
										</div> -->
								        <div id="toolbar" align="right">
								        	
								            <button type="button" onclick="javascript:unloadProgress_click(${taskId});" class="btn default" >货物进度
								            </button>
								            <button type="button" onclick="javascript:unloaderOverview_click(${taskId});" class="btn default" >卸船机总览
								            </button>
								            								            
								        </div>
										<div class="portlet-body" style="display: block;">											
											  <table id="unshipInfo" class="table table-striped table-bordered table-hover table-checkable order-column"></table>												            
										</div>
										<div style="text-align: center">
											<c:choose>
												<c:when test="${task.status == 0 || task.status == 1}">
													...
													<button id="sample_editable_1_new" class="btn default"
														onclick="javascript:modifyCabinPosition_click(${taskId});">
														舱口标定 <i class="fa"></i>
													</button>
													</security:authorize>
												</c:when>
											...
											<c:choose>
												<c:when test="${task.status == 0}">
													<button id="sample_editable_1_new" class="btn default"
														onclick="javascript:setShipStatus_click('${taskId}','0');">
														开始卸船 <i class="fa"></i>
													</button>
												</c:when>
												...
												<security:authorize buttonUrl="9">
													<button id="sample_editable_1_new" class="btn default"
														onclick="javascript:setShipStatus_click('${taskId}','1');">
														完成卸船 <i class="fa"></i>
													</button>
												</security:authorize>
												</c:when>
...
<script src="${IncPath}/assets/global/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" type="text/javascript"></script>
	...
	<script src="${IncPath}/core/unshipInfo/unloadlist.js?v=${jsVersion}" type="text/javascript"></script>
	<!-- BEGIN THEME LAYOUT SCRIPTS -->
