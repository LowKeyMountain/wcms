						                    ...
						                    <div class="panel panel-default">
						                        <div class="panel-body">
						                            <ul class="nav nav-pills">
						                                <li class=""><a href="#ykcb" data-toggle="tab">预靠船舶</a>
						                                </li>
						                                <li class="active"><a href="#zycb" data-toggle="tab">作业船舶</a>
						                                </li>
						                            ...
						                            <div class="tab-content">
						                                <div class="tab-pane fade" id="ykcb">
															<table id="ykcbship" class="table table-checkable table-hover"></table>
														</div>
						                                <div class="tab-pane fade active in" id="zycb">
															<table id="zycbship" class="table table-checkable table-hover"></table>
<!-- 															<table
						                                ...
						                                <div class="tab-pane fade" id="lgcb">
															<table id="lgcbship" class="table table-checkable table-hover"></table>
<!-- 						 									<table
																class="table table-striped table-bordered table-hover table-checkable order-column"
																id="datatable_lgcb">
																<thead>
...
<!--         <script src="${IncPath}/assets/global/scripts/datatable.js" type="text/javascript"></script>
		...
		<script src="${IncPath}/ship/ship.js?v=112"
			type="text/javascript"></script>
		<!-- BEGIN THEME LAYOUT SCRIPTS -->
